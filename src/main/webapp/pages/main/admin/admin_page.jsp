...
<input type="hidden" id="editing_message" value="<%= request.getAttribute("editing_message") %>"/>
<nav class="container-movie-navbar">
    <div class="container-navbar">
        <div class="nav-link-left" style="width: 350px;">
            ...
            <form class="nav-link" action="${pageContext.request.contextPath}/controller">
        ...
        <form class="nav-link-logout" action="${pageContext.request.contextPath}/controller">
    ...
    <div class="carousel-inner ">
        ...
        <c:forEach var="new_films" items="${new_list}">
            <div class="carousel-item" data-bs-interval="3000000">
                ...
                <form action="${pageContext.request.contextPath}/controller" style="
                position: absolute;
                left: 54px;
                bottom: 5px;
                z-index: 10;">
                    ...
                    <button type="submit" value="${new_films.id}" name="id" class="btn btn-outline-primary">
                ...
                z-index: 10;">
                    ...
                    <input type="hidden" name="return_page" value="admin_page"/>
                    <button type="submit" value="${new_films.id}" name="id" class="btn btn-outline-danger">
        ...
        <c:forEach var="best" items="${best_list}">
            <div class="carousel-item" data-bs-interval="3000">
                ...
                z-index: 10;">
                    <input type="hidden" name="command" value="update_movie"/>
                    <input type="hidden" name="return_page" value="admin_page"/>
                    <button type="submit" value="${best.id}" name="id" class="btn btn-outline-primary">
                        <i class="fa-solid fa-wrench"></i>
                    </button>
                </form>
                ...
                z-index: 10;">
                    <input type="hidden" name="command" value="delete_movie"/>
                    <input type="hidden" name="return_page" value="admin_page"/>
                    <button type="submit" value="${best.id}" name="id" class="btn btn-outline-danger">
                        <i class="fa-solid fa-trash"></i>
                    </button>
                </form>
            </div>
        ...
        <c:forEach var="adventure" items="${adventure_list}">
            <div class="carousel-item" data-bs-interval="3000">
                ...
                z-index: 10;">
                    <input type="hidden" name="command" value="update_movie"/>
                    <input type="hidden" name="return_page" value="admin_page"/>
                    <button type="submit" value="${adventure.id}" name="id" class="btn btn-outline-primary">
                        <i class="fa-solid fa-wrench"></i>
                    </button>
                </form>
                ...
                z-index: 10;">
                    <input type="hidden" name="command" value="delete_movie"/>
                    <input type="hidden" name="return_page" value="admin_page"/>
                    <button type="submit" value="${adventure.id}" name="id" class="btn btn-outline-danger">
                        <i class="fa-solid fa-trash"></i>
                    </button>
                </form>
            </div>
        ...
        <c:forEach var="cartoon" items="${cartoon_list}">
            <div class="carousel-item" data-bs-interval="3000">
                ...
                z-index: 10;">
                    <input type="hidden" name="command" value="update_movie"/>
                    <input type="hidden" name="return_page" value="admin_page"/>
                    <button type="submit" value="${cartoon.id}" name="id" class="btn btn-outline-primary">
                        <i class="fa-solid fa-wrench"></i>
                    </button>
                </form>
                ...
                z-index: 10;">
                    <input type="hidden" name="command" value="delete_movie"/>
                    <input type="hidden" name="return_page" value="admin_page"/>
                    <button type="submit" value="${cartoon.id}" name="id" class="btn btn-outline-danger">
                        <i class="fa-solid fa-trash"></i>
                    </button>
                </form>
            </div>
        ...
        <c:forEach var="comedy" items="${comedy_list}">
            <div class="carousel-item" data-bs-interval="3000">
                ...
                z-index: 10;">
                    <input type="hidden" name="command" value="update_movie"/>
                    <input type="hidden" name="return_page" value="admin_page"/>
                    <button type="submit" value="${comedy.id}" name="id" class="btn btn-outline-primary">
                        <i class="fa-solid fa-wrench"></i>
                    </button>
                </form>
                ...
                z-index: 10;">
                    <input type="hidden" name="command" value="delete_movie"/>
                    <input type="hidden" name="return_page" value="admin_page"/>
                    <button type="submit" value="${comedy.id}" name="id" class="btn btn-outline-danger">
                        <i class="fa-solid fa-trash"></i>
                    </button>
                </form>
            </div>
...
<script type="text/javascript">
    ...
    var updating_status = document.getElementById("editing_message").value;
    if (updating_status == "success") {
        swal("Done", "Successfully updated movie", "success");
    }
    if (updating_status == "fail") {
