...
public class MovieCategoryPageCommand implements Command {
    ...
    public Router execute(HttpServletRequest request) throws CommandException {
        ...
        try {
            ...
            session.setAttribute(CURRENT_PAGE, PagePath.PAGE_BY_CATEGORY_MOVIE);
            router = new Router(PagePath.PAGE_BY_CATEGORY_MOVIE, Router.Type.FORWARD);
